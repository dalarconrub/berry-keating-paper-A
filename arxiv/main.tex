...
is smooth~\cite{alarcon2026c}. The coefficient $c$ is independently confirmed by \emph{ab initio} calculation from the Conrey--Snaith triple correlation formula~\cite{alarcon2026b}, yielding $c_{\mathrm{CS}} = 1.24$ ($99\%$ of the empirical value) via Richardson extrapolation at $L = 1000$ and $L = 3000$. Nevertheless, computing $c$ analytically in closed form from $\delta b_2$ remains an open problem.
